  ...
  return (
    <>
      ...
      <button
        ...
        className={`absolute top-24 left-4 z-50 lg:hidden p-2 rounded-lg bg-[#570020] text-white shadow-lg transition-opacity duration-300 ${
      ...
      {/* Sidebar */}
      <aside
        className={`fixed inset-y-0 left-0 bg-[#570020] text-white transition-transform duration-300 z-50 shadow-2xl ${
          isOpen ? 'translate-x-0' : '-translate-x-full'
        } lg:translate-x-0 lg:sticky lg:top-0 lg:h-screen lg:z-40 w-64 overflow-y-auto flex flex-col`}
      >
